...
export const generateMetadata = (): Metadata => {
  const pageTitle = `Servicios | ${seoConfig.author}`;
  const pageDescription =
    "Desarrollo Full Stack, e-commerce, ERP y automatización. Soluciones escalables a medida.";
  ...
  return {
    ...
    alternates: {
      canonical: `${seoConfig.url}/services`,
    },
